...
Rule 5, "don't abbreviate" is a very simple rule. It's basic statement is about the use of abbreviations.
...
Rule 6, "keep all entities small", restricts the number of lines in a class.
\\
...
During this research, one way of bypassing getter methods was found. The next section will comment the solution for getter methods by explaining the bypassing by solution.
