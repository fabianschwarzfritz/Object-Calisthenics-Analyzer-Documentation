...
[font=\small, edge from parent, 
    ...
    child { node { TypeDeclaration }
        child { node { StaticField1Declaration } [ draw=blue!60 ] }
        child { node { Field1Declaration } [ draw=green!60 ] }
        child { node { Field2Declaration } [ draw=green!60 ] }
        child { node { Field3Declaration } [ draw=red!60 ] }
        child { node { Method1Declaration } }
        child { node { Method2Declaration } }
        child { node { Method3Declaration } }
        child { node { Method4Declaration } }
        child { node { Method5Declaration } }
    };
\end{tikzpicture}
\label{ast:rule7}
