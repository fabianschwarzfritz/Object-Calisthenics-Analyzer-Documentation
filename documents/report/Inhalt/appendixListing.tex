...
\lstinputlisting[label=listing:rule2examplenull:mainnull,caption=Example 2 of class \textit{MainNull}]{listing/rule2/examplenull/MainNull.java}
%\label{listing:rule2example2}

\begin[label=listing:nullobject1,caption=Null check, implemented by using a conditional]{lstlisting}
...
\begin[label=listing:nullobject4,caption=Null check, implemented by using a conditional]{lstlisting}
Object value = a.method();
if(value == null) {
	...
}
